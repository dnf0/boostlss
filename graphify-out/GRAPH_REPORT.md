...
## Corpus Check
- 109 files · ~100,743 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1219 nodes · 1117 edges · 124 communities (101 shown, 23 thin omitted)
...
Cohesion: 0.12
Nodes (16): Advanced: Skills with executable code, [Analysis Title], Anti-patterns to avoid, Avoid offering too many options, Avoid Windows-style paths, Build evaluations first, Conditional workflow pattern, Develop Skills iteratively with Claude (+8 more)
...
Cohesion: 0.50
Nodes (3): agent-rules templates, Customisation, Quick start

## Knowledge Gaps
- **900 isolated node(s):** `start-server.sh script`, `stop-server.sh script`, `find-polluter.sh script`, `fs`, `path` (+895 more)
...
- **Why does `Writing Skills` connect `Community 27` to `Community 66`, `Community 67`, `Community 78`, `Community 79`, `Community 88`, `Community 89`, `Community 90`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Returns: "OK" or lists conflicts` connect `Community 33` to `Community 0`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
